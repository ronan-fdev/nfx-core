...
namespace nfx::core::hashing
{
	 ...
	 */
	[[nodiscard]] inline constexpr uint32_t Larson( uint32_t hash, uint8_t ch ) noexcept;
	 ...
	 * @note This function is marked [[nodiscard]] - the return value should not be ignored
	 */
	[[nodiscard]] inline uint32_t crc32( uint32_t hash, uint8_t ch ) noexcept;
	 ...
	 * @note This function is marked [[nodiscard]] - the return value should not be ignored
	 */
	[[nodiscard]] inline constexpr uint32_t combine( uint32_t existing, uint32_t newHash, uint32_t prime ) noexcept;
	 ...
	 * @note This function is marked [[nodiscard]] - the return value should not be ignored
	 */
	[[nodiscard]] inline constexpr size_t combine( size_t existing, size_t newHash ) noexcept;
	 ...
	 */
	template <typename T>
	[[nodiscard]] inline constexpr std::enable_if_t<std::is_integral_v<T>, size_t> hashInteger( T value ) noexcept;
} // namespace nfx::core::hashing
