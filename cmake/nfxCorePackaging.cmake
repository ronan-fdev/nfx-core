#==============================================================================
# nfx-core - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_CORE_PACKAGE_SOURCE
		AND NOT NFX_CORE_PACKAGE_ARCHIVE
		AND NOT NFX_CORE_PACKAGE_DEB
		AND NOT NFX_CORE_PACKAGE_RPM
		AND NOT NFX_CORE_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "C++ core utilities library - Foundation of the nfx ecosystem with hashing algorithms and CPU feature detection")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_CORE_LICENSE_FILE})
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- WiX packages ---
	if(NFX_CORE_PACKAGE_WIX AND WIN32)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_CORE_LICENSE})
